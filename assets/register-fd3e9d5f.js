...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-abbf4c1b.js"), true ? ["assets/provider-abbf4c1b.js","assets/provider-4530e4cc.js","assets/app-72f0b7d2.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-0de49dae.js"), true ? ["assets/provider-0de49dae.js","assets/provider-4530e4cc.js","assets/app-72f0b7d2.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-02788eeb.js"), true ? ["assets/provider-02788eeb.js","assets/provider-0de49dae.js","assets/provider-4530e4cc.js","assets/app-72f0b7d2.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-46423219.js"), true ? ["assets/prod-46423219.js","assets/app-72f0b7d2.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-46423219.js"), true ? ["assets/prod-46423219.js","assets/app-72f0b7d2.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-46423219.js"), true ? ["assets/prod-46423219.js","assets/app-72f0b7d2.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-c6d4c4ed.js"), true ? ["assets/srt-parser-c6d4c4ed.js","assets/app-72f0b7d2.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-fc17421e.js"), true ? ["assets/ssa-parser-fc17421e.js","assets/app-72f0b7d2.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-b265f78e.js"), true ? ["assets/errors-b265f78e.js","assets/app-72f0b7d2.js"] : void 0)).ParseErrorBuilder;
  }
