...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-d69bb49e.js"), true ? ["assets/provider-d69bb49e.js","assets/provider-d2195e27.js","assets/app-633802df.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-d77312e3.js"), true ? ["assets/provider-d77312e3.js","assets/provider-d2195e27.js","assets/app-633802df.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-a318b53d.js"), true ? ["assets/provider-a318b53d.js","assets/provider-d77312e3.js","assets/provider-d2195e27.js","assets/app-633802df.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-1aacb39d.js"), true ? ["assets/prod-1aacb39d.js","assets/app-633802df.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-1aacb39d.js"), true ? ["assets/prod-1aacb39d.js","assets/app-633802df.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-1aacb39d.js"), true ? ["assets/prod-1aacb39d.js","assets/app-633802df.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-e794b6e1.js"), true ? ["assets/srt-parser-e794b6e1.js","assets/app-633802df.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-085875b9.js"), true ? ["assets/ssa-parser-085875b9.js","assets/app-633802df.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-80e9c09f.js"), true ? ["assets/errors-80e9c09f.js","assets/app-633802df.js"] : void 0)).ParseErrorBuilder;
  }
