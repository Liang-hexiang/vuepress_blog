...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-6c29d268.js"), true ? ["assets/provider-6c29d268.js","assets/provider-c97e3bcf.js","assets/app-1b1c230d.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-a4d64a9a.js"), true ? ["assets/provider-a4d64a9a.js","assets/provider-c97e3bcf.js","assets/app-1b1c230d.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-e77b07a5.js"), true ? ["assets/provider-e77b07a5.js","assets/provider-a4d64a9a.js","assets/provider-c97e3bcf.js","assets/app-1b1c230d.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-57166d2f.js"), true ? ["assets/prod-57166d2f.js","assets/app-1b1c230d.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-57166d2f.js"), true ? ["assets/prod-57166d2f.js","assets/app-1b1c230d.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-57166d2f.js"), true ? ["assets/prod-57166d2f.js","assets/app-1b1c230d.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-ed97f0cf.js"), true ? ["assets/srt-parser-ed97f0cf.js","assets/app-1b1c230d.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-cdbf8e9a.js"), true ? ["assets/ssa-parser-cdbf8e9a.js","assets/app-1b1c230d.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-407976c4.js"), true ? ["assets/errors-407976c4.js","assets/app-1b1c230d.js"] : void 0)).ParseErrorBuilder;
  }
