...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-163fea31.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-9517bd3d.js"), true ? ["assets/errors-9517bd3d.js","assets/register-163fea31.js","assets/app-a222c416.js"] : void 0)).ParseErrorBuilder;
  }
