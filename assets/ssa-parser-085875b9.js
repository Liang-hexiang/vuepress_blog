...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-de735f49.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-80e9c09f.js"), true ? ["assets/errors-80e9c09f.js","assets/register-de735f49.js","assets/app-633802df.js"] : void 0)).ParseErrorBuilder;
  }
