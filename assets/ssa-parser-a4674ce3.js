...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-9df03af0.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-8adea54e.js"), true ? ["assets/errors-8adea54e.js","assets/register-9df03af0.js","assets/app-43c6e3af.js"] : void 0)).ParseErrorBuilder;
  }
