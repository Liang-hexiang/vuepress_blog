...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-1c1f1754.js"), true ? ["assets/provider-1c1f1754.js","assets/provider-b84d7cab.js","assets/app-45c468b1.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-11ab984e.js"), true ? ["assets/provider-11ab984e.js","assets/provider-b84d7cab.js","assets/app-45c468b1.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-75baf21d.js"), true ? ["assets/provider-75baf21d.js","assets/provider-11ab984e.js","assets/provider-b84d7cab.js","assets/app-45c468b1.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-d9014afa.js"), true ? ["assets/prod-d9014afa.js","assets/app-45c468b1.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-d9014afa.js"), true ? ["assets/prod-d9014afa.js","assets/app-45c468b1.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-d9014afa.js"), true ? ["assets/prod-d9014afa.js","assets/app-45c468b1.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-06e818b9.js"), true ? ["assets/srt-parser-06e818b9.js","assets/app-45c468b1.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-8a657e59.js"), true ? ["assets/ssa-parser-8a657e59.js","assets/app-45c468b1.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-9c958c2a.js"), true ? ["assets/errors-9c958c2a.js","assets/app-45c468b1.js"] : void 0)).ParseErrorBuilder;
  }
