import{_ as n,o as s,c as a,a as t}from"./app-d36c3dca.js";const p={},e=t(`<h1 id="单例模式" tabindex="-1"><a class="header-anchor" href="#单例模式" aria-hidden="true">#</a> 单例模式</h1><div class="hint-container info"><p class="hint-container-title">单例模式</p><p>单例模式是一种创建型设计模式， 让你能够保证一个类只有一个实例， 并提供一个访问该实例的全局节点。</p></div><h2 id="单例模式结构" tabindex="-1"><a class="header-anchor" href="#单例模式结构" aria-hidden="true">#</a> 单例模式结构</h2><figure><img src="https://raw.githubusercontent.com/lianghexiang/picgo-picture/main/vuepress/2024-04-26-bWP3E8.png" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h2 id="单例模式的python实现" tabindex="-1"><a class="header-anchor" href="#单例模式的python实现" aria-hidden="true">#</a> 单例模式的Python实现</h2><h3 id="_1-普通单例模式" tabindex="-1"><a class="header-anchor" href="#_1-普通单例模式" aria-hidden="true">#</a> 1. 普通单例模式</h3><blockquote><p>_ <em>new</em> _方法可以在实例化类的时候通过hasattr方法返回同一个实例</p></blockquote><p>:sad:</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token keyword">class</span> <span class="token class-name">ExerciseSinglePattern</span><span class="token punctuation">:</span>
...
<span class="token operator">&lt;</span>__main__<span class="token punctuation">.</span>Logger <span class="token builtin">object</span> at <span class="token number">0x00000204A6EFFCA0</span><span class="token operator">&gt;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在上面的代码中，我们通过继承<code>type</code>类，然后重写<code>__call__</code>的方法，每次创建实例的时候都去<code>_instances</code>中去寻找已经创建的实例，然后返回。</p><h3 id="_5-单例模式的缺点" tabindex="-1"><a class="header-anchor" href="#_5-单例模式的缺点" aria-hidden="true">#</a> 5. 单例模式的缺点</h3><p>单例具有全局访问权限，因此会存在以下问题。</p><p>全局变量可能在某处代码被修改，但是开发人员并未注意到，如果有其它地方也使用，可能会发生异常。</p><p>由于单例只能创建一次，所以会有多个引用指向同一个对象。</p><p>所有依赖全局变量的类都会由于一个类的改变而紧密耦合为全局数据，从而可能无意中影响另一个类。</p>`,60),o=[e];function c(i,l){return s(),a("div",null,o)}const r=n(p,[["render",c],["__file","单例模式.html.vue"]]);export{r as default};
