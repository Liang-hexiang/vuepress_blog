...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-adb9afe5.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-407976c4.js"), true ? ["assets/errors-407976c4.js","assets/register-adb9afe5.js","assets/app-1b1c230d.js"] : void 0)).ParseErrorBuilder;
  }
