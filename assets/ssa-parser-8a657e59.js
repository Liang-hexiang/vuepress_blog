...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-0bd9bb7c.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-9c958c2a.js"), true ? ["assets/errors-9c958c2a.js","assets/register-0bd9bb7c.js","assets/app-45c468b1.js"] : void 0)).ParseErrorBuilder;
  }
