...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-ca531a72.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-121df15d.js"), true ? ["assets/errors-121df15d.js","assets/register-ca531a72.js","assets/app-44cf68a7.js"] : void 0)).ParseErrorBuilder;
  }
