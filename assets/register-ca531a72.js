...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-fd8f20fe.js"), true ? ["assets/provider-fd8f20fe.js","assets/provider-eb4f03c2.js","assets/app-44cf68a7.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-4bdaeb78.js"), true ? ["assets/provider-4bdaeb78.js","assets/provider-eb4f03c2.js","assets/app-44cf68a7.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-6290edc1.js"), true ? ["assets/provider-6290edc1.js","assets/provider-4bdaeb78.js","assets/provider-eb4f03c2.js","assets/app-44cf68a7.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-d8fea06b.js"), true ? ["assets/prod-d8fea06b.js","assets/app-44cf68a7.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-d8fea06b.js"), true ? ["assets/prod-d8fea06b.js","assets/app-44cf68a7.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-d8fea06b.js"), true ? ["assets/prod-d8fea06b.js","assets/app-44cf68a7.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-e77f12d3.js"), true ? ["assets/srt-parser-e77f12d3.js","assets/app-44cf68a7.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-73af753f.js"), true ? ["assets/ssa-parser-73af753f.js","assets/app-44cf68a7.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-121df15d.js"), true ? ["assets/errors-121df15d.js","assets/app-44cf68a7.js"] : void 0)).ParseErrorBuilder;
  }
