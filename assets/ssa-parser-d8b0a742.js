...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-9ca3ff69.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-9c4cdfa7.js"), true ? ["assets/errors-9c4cdfa7.js","assets/register-9ca3ff69.js","assets/app-a7828117.js"] : void 0)).ParseErrorBuilder;
  }
