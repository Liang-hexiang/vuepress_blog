...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-682bbe79.js"), true ? ["assets/provider-682bbe79.js","assets/provider-316e87cb.js","assets/app-af2d9ada.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-cfd6e7ad.js"), true ? ["assets/provider-cfd6e7ad.js","assets/provider-316e87cb.js","assets/app-af2d9ada.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-e06f06cf.js"), true ? ["assets/provider-e06f06cf.js","assets/provider-cfd6e7ad.js","assets/provider-316e87cb.js","assets/app-af2d9ada.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-33c9de8d.js"), true ? ["assets/prod-33c9de8d.js","assets/app-af2d9ada.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-33c9de8d.js"), true ? ["assets/prod-33c9de8d.js","assets/app-af2d9ada.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-33c9de8d.js"), true ? ["assets/prod-33c9de8d.js","assets/app-af2d9ada.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-42030ab7.js"), true ? ["assets/srt-parser-42030ab7.js","assets/app-af2d9ada.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-ff626c73.js"), true ? ["assets/ssa-parser-ff626c73.js","assets/app-af2d9ada.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-45cd857a.js"), true ? ["assets/errors-45cd857a.js","assets/app-af2d9ada.js"] : void 0)).ParseErrorBuilder;
  }
