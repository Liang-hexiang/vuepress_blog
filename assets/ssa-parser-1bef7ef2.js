...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-d58a62ea.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-aa7d88e4.js"), true ? ["assets/errors-aa7d88e4.js","assets/register-d58a62ea.js","assets/app-9387156d.js"] : void 0)).ParseErrorBuilder;
  }
