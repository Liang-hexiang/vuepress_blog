...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-b25ec70a.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-f877c9b1.js"), true ? ["assets/errors-f877c9b1.js","assets/register-b25ec70a.js","assets/app-ef9c1d43.js"] : void 0)).ParseErrorBuilder;
  }
