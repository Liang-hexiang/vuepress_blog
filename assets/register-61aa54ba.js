...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-72a02375.js"), true ? ["assets/provider-72a02375.js","assets/provider-624b9bdf.js","assets/app-236d81d8.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-90f9b224.js"), true ? ["assets/provider-90f9b224.js","assets/provider-624b9bdf.js","assets/app-236d81d8.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-bac5dba2.js"), true ? ["assets/provider-bac5dba2.js","assets/provider-90f9b224.js","assets/provider-624b9bdf.js","assets/app-236d81d8.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-d288a0ec.js"), true ? ["assets/prod-d288a0ec.js","assets/app-236d81d8.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-d288a0ec.js"), true ? ["assets/prod-d288a0ec.js","assets/app-236d81d8.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-d288a0ec.js"), true ? ["assets/prod-d288a0ec.js","assets/app-236d81d8.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-9290b644.js"), true ? ["assets/srt-parser-9290b644.js","assets/app-236d81d8.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-fcf101f6.js"), true ? ["assets/ssa-parser-fcf101f6.js","assets/app-236d81d8.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-b631ae55.js"), true ? ["assets/errors-b631ae55.js","assets/app-236d81d8.js"] : void 0)).ParseErrorBuilder;
  }
