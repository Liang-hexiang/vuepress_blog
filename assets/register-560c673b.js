...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-ef04e14a.js"), true ? ["assets/provider-ef04e14a.js","assets/provider-f1c7442f.js","assets/app-d6533bb6.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-c3b6f4b9.js"), true ? ["assets/provider-c3b6f4b9.js","assets/provider-f1c7442f.js","assets/app-d6533bb6.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-b913f8b4.js"), true ? ["assets/provider-b913f8b4.js","assets/provider-c3b6f4b9.js","assets/provider-f1c7442f.js","assets/app-d6533bb6.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-d9770738.js"), true ? ["assets/prod-d9770738.js","assets/app-d6533bb6.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-d9770738.js"), true ? ["assets/prod-d9770738.js","assets/app-d6533bb6.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-d9770738.js"), true ? ["assets/prod-d9770738.js","assets/app-d6533bb6.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-bbab3289.js"), true ? ["assets/srt-parser-bbab3289.js","assets/app-d6533bb6.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-71fc42cc.js"), true ? ["assets/ssa-parser-71fc42cc.js","assets/app-d6533bb6.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-a92f9a8a.js"), true ? ["assets/errors-a92f9a8a.js","assets/app-d6533bb6.js"] : void 0)).ParseErrorBuilder;
  }
