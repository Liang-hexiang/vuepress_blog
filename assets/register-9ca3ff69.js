...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-dceb18be.js"), true ? ["assets/provider-dceb18be.js","assets/provider-c2b6db6b.js","assets/app-a7828117.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-01d7ae7e.js"), true ? ["assets/provider-01d7ae7e.js","assets/provider-c2b6db6b.js","assets/app-a7828117.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-20d82708.js"), true ? ["assets/provider-20d82708.js","assets/provider-01d7ae7e.js","assets/provider-c2b6db6b.js","assets/app-a7828117.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-84848400.js"), true ? ["assets/prod-84848400.js","assets/app-a7828117.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-84848400.js"), true ? ["assets/prod-84848400.js","assets/app-a7828117.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-84848400.js"), true ? ["assets/prod-84848400.js","assets/app-a7828117.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-018c967d.js"), true ? ["assets/srt-parser-018c967d.js","assets/app-a7828117.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-d8b0a742.js"), true ? ["assets/ssa-parser-d8b0a742.js","assets/app-a7828117.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-9c4cdfa7.js"), true ? ["assets/errors-9c4cdfa7.js","assets/app-a7828117.js"] : void 0)).ParseErrorBuilder;
  }
