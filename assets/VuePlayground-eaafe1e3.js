import { g as defineComponent, h as r, j as ref, k as shallowRef, l as computed, v, m as onMounted, n as h, C, _ as __vitePreload } from "./app-43c6e3af.js";
const style = "";
const vuePlayground = "";
...
var w = defineComponent({ name: "VuePlayground", props: { title: { type: String, default: "" }, files: { type: String, required: true }, settings: { type: String, default: "{}" } }, setup(e) {
  const u = r(), l = ref(true), o = shallowRef(), a = shallowRef(), n = computed(() => v({}, u, V(e.settings))), i = async () => {
    const { ReplStore: s, Repl: p } = await __vitePreload(() => import("./vue-repl-0db874d3.js"), true ? ["assets/vue-repl-0db874d3.js","assets/app-43c6e3af.js"] : void 0);
