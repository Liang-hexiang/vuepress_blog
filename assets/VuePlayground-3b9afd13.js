import { j as defineComponent, k as r, l as ref, m as shallowRef, n as computed, v, p as onMounted, q as h, C, h as __vitePreload } from "./app-a222c416.js";
const style = "";
const vuePlayground = "";
...
var w = defineComponent({ name: "VuePlayground", props: { title: { type: String, default: "" }, files: { type: String, required: true }, settings: { type: String, default: "{}" } }, setup(e) {
  const u = r(), l = ref(true), o = shallowRef(), a = shallowRef(), n = computed(() => v({}, u, V(e.settings))), i = async () => {
    const { ReplStore: s, Repl: p } = await __vitePreload(() => import("./vue-repl-abe55a71.js"), true ? ["assets/vue-repl-abe55a71.js","assets/app-a222c416.js"] : void 0);
