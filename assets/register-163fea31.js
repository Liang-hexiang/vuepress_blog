...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-ba2814c6.js"), true ? ["assets/provider-ba2814c6.js","assets/provider-a3645e46.js","assets/app-a222c416.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-41b79c38.js"), true ? ["assets/provider-41b79c38.js","assets/provider-a3645e46.js","assets/app-a222c416.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-ed6308c8.js"), true ? ["assets/provider-ed6308c8.js","assets/provider-41b79c38.js","assets/provider-a3645e46.js","assets/app-a222c416.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-9fc4e5df.js"), true ? ["assets/prod-9fc4e5df.js","assets/app-a222c416.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-9fc4e5df.js"), true ? ["assets/prod-9fc4e5df.js","assets/app-a222c416.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-9fc4e5df.js"), true ? ["assets/prod-9fc4e5df.js","assets/app-a222c416.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-fe01fc30.js"), true ? ["assets/srt-parser-fe01fc30.js","assets/app-a222c416.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-9e0b06f3.js"), true ? ["assets/ssa-parser-9e0b06f3.js","assets/app-a222c416.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-9517bd3d.js"), true ? ["assets/errors-9517bd3d.js","assets/app-a222c416.js"] : void 0)).ParseErrorBuilder;
  }
