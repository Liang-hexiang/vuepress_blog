...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-560c673b.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-a92f9a8a.js"), true ? ["assets/errors-a92f9a8a.js","assets/register-560c673b.js","assets/app-d6533bb6.js"] : void 0)).ParseErrorBuilder;
  }
