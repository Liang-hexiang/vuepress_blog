import { g as defineComponent, h as r, j as ref, k as shallowRef, l as computed, v, m as onMounted, n as h, C, _ as __vitePreload } from "./app-1b1c230d.js";
const style = "";
const vuePlayground = "";
...
var w = defineComponent({ name: "VuePlayground", props: { title: { type: String, default: "" }, files: { type: String, required: true }, settings: { type: String, default: "{}" } }, setup(e) {
  const u = r(), l = ref(true), o = shallowRef(), a = shallowRef(), n = computed(() => v({}, u, V(e.settings))), i = async () => {
    const { ReplStore: s, Repl: p } = await __vitePreload(() => import("./vue-repl-dd954882.js"), true ? ["assets/vue-repl-dd954882.js","assets/app-1b1c230d.js"] : void 0);
