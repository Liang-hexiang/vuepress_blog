...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-e6aea153.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-45cd857a.js"), true ? ["assets/errors-45cd857a.js","assets/register-e6aea153.js","assets/app-af2d9ada.js"] : void 0)).ParseErrorBuilder;
  }
