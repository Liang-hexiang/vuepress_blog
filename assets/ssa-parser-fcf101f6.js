...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-61aa54ba.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-b631ae55.js"), true ? ["assets/errors-b631ae55.js","assets/register-61aa54ba.js","assets/app-236d81d8.js"] : void 0)).ParseErrorBuilder;
  }
