...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-a1c2ce86.js"), true ? ["assets/provider-a1c2ce86.js","assets/provider-6fd40743.js","assets/app-43c6e3af.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-bedcaf06.js"), true ? ["assets/provider-bedcaf06.js","assets/provider-6fd40743.js","assets/app-43c6e3af.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-dd1ead7e.js"), true ? ["assets/provider-dd1ead7e.js","assets/provider-bedcaf06.js","assets/provider-6fd40743.js","assets/app-43c6e3af.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-56471d01.js"), true ? ["assets/prod-56471d01.js","assets/app-43c6e3af.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-56471d01.js"), true ? ["assets/prod-56471d01.js","assets/app-43c6e3af.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-56471d01.js"), true ? ["assets/prod-56471d01.js","assets/app-43c6e3af.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-81ca9b86.js"), true ? ["assets/srt-parser-81ca9b86.js","assets/app-43c6e3af.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-a4674ce3.js"), true ? ["assets/ssa-parser-a4674ce3.js","assets/app-43c6e3af.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-8adea54e.js"), true ? ["assets/errors-8adea54e.js","assets/app-43c6e3af.js"] : void 0)).ParseErrorBuilder;
  }
