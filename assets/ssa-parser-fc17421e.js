...
import { V as VTTCue, g as parseVTTTimestamp } from "./register-fd3e9d5f.js";
...
class SSAParser {
  ...
  async init(init) {
    this.f = init;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-b265f78e.js"), true ? ["assets/errors-b265f78e.js","assets/register-fd3e9d5f.js","assets/app-72f0b7d2.js"] : void 0)).ParseErrorBuilder;
  }
