...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-604e617d.js"), true ? ["assets/provider-604e617d.js","assets/provider-d97497f1.js","assets/app-9387156d.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-1e099a29.js"), true ? ["assets/provider-1e099a29.js","assets/provider-d97497f1.js","assets/app-9387156d.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-33d42036.js"), true ? ["assets/provider-33d42036.js","assets/provider-1e099a29.js","assets/provider-d97497f1.js","assets/app-9387156d.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-b215d090.js"), true ? ["assets/prod-b215d090.js","assets/app-9387156d.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-b215d090.js"), true ? ["assets/prod-b215d090.js","assets/app-9387156d.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-b215d090.js"), true ? ["assets/prod-b215d090.js","assets/app-9387156d.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-d9ce3c2d.js"), true ? ["assets/srt-parser-d9ce3c2d.js","assets/app-9387156d.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-1bef7ef2.js"), true ? ["assets/ssa-parser-1bef7ef2.js","assets/app-9387156d.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-aa7d88e4.js"), true ? ["assets/errors-aa7d88e4.js","assets/app-9387156d.js"] : void 0)).ParseErrorBuilder;
  }
