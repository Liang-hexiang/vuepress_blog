<template><div><h1 id="工厂模式" tabindex="-1"><a class="header-anchor" href="#工厂模式" aria-hidden="true">#</a> 工厂模式</h1>
<h3 id="_1-前言" tabindex="-1"><a class="header-anchor" href="#_1-前言" aria-hidden="true">#</a> 1. 前言</h3>
...
<h3 id="_2-了解工厂模式" tabindex="-1"><a class="header-anchor" href="#_2-了解工厂模式" aria-hidden="true">#</a> 2. 了解工厂模式</h3>
