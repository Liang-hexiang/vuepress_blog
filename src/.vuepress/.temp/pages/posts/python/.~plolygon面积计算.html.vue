<template><div><h1 id="python操作polygon" tabindex="-1"><a class="header-anchor" href="#python操作polygon" aria-hidden="true">#</a> Python操作Polygon</h1>
<h3 id="_1-polygon面积计算" tabindex="-1"><a class="header-anchor" href="#_1-polygon面积计算" aria-hidden="true">#</a> 1. Polygon面积计算</h3>
<blockquote>
<p>首先介绍什么是Polygon，在地理信息系统(GIS)中，polygon是经纬度构成的多边形，可以用来描绘地理边界，区域和建筑物轮廓灯。在mysql中，可以使用polygon数据类型存储，Python的<code v-pre>Shapely</code>库提供了操作polygon数据的工具。</p>
</blockquote>
<p>在编程语言中，polygon数据多存储在二维列表中，例如<code v-pre>[[1, 2],[2, 0], [0, 1],......]</code>,  在数学中计算不规则多边形面积之一的公式是鞋带公式(也成高斯面积公式)</p>
<p>对于任意一个多边形，如果已知其各个顶点的坐标，<img src="@source/posts/python/C:/Users/admin/AppData/Roaming/Typora/typora-user-images/image-20230701165345340.png" alt="image-20230701165345340" loading="lazy"></p>
<p>那么这个多边形的面积为：</p>
<figure><img src="@source/posts/python/C:/Users/admin/AppData/Roaming/Typora/typora-user-images/image-20230701165640479.png" alt="image-20230701165640479" tabindex="0" loading="lazy"><figcaption>image-20230701165640479</figcaption></figure>
<p>其中y(i+1)=y1, x(i+1)=x1</p>
<p><a href="https://blog.csdn.net/xza13155/article/details/112118676" target="_blank" rel="noopener noreferrer">https://blog.csdn.net/xza13155/article/details/112118676<ExternalLinkIcon/></a></p>
<p>把上述公式转换成Python计算polygon边界面积的代码：</p>
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">def</span> <span class="token function">polygon_area</span><span class="token punctuation">(</span>polygon<span class="token punctuation">)</span><span class="token punctuation">:</span>
...
<div class="language-python line-numbers-mode" data-ext="py"><pre v-pre class="language-python"><code><span class="token keyword">from</span> shapely<span class="token punctuation">.</span>geometry <span class="token keyword">import</span> Polygon
