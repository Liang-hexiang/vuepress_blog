<template><div><h1 id="vue客户端" tabindex="-1"><a class="header-anchor" href="#vue客户端" aria-hidden="true">#</a> Vue客户端</h1>
<h3 id="_1-什么是webpack" tabindex="-1"><a class="header-anchor" href="#_1-什么是webpack" aria-hidden="true">#</a> 1. 什么是webpack</h3>
<blockquote>
...
<h3 id="_2-安装webpack" tabindex="-1"><a class="header-anchor" href="#_2-安装webpack" aria-hidden="true">#</a> 2. 安装webpack</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>PS C:<span class="token punctuation">\</span>Users<span class="token punctuation">\</span>Administrator<span class="token operator">></span> <span class="token function">npm</span> i webpack@3.12.0 <span class="token parameter variable">-g</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="diy脚手架" tabindex="-1"><a class="header-anchor" href="#diy脚手架" aria-hidden="true">#</a> DIY脚手架</h3>
<h4 id="_1-cmd规范" tabindex="-1"><a class="header-anchor" href="#_1-cmd规范" aria-hidden="true">#</a> 1. cmd规范</h4>
<ol>
<li>抛出：module.exports = xxx</li>
<li>引用：require(相对路径)</li>
</ol>
<h4 id="_2-es6-module" tabindex="-1"><a class="header-anchor" href="#_2-es6-module" aria-hidden="true">#</a> 2. ES6  module</h4>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> person<span class="token punctuation">;</span>
...
使用webpack支持模块化</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>E:<span class="token punctuation">\</span>giteePython<span class="token punctuation">\</span>FrontEndStudy<span class="token punctuation">\</span>Vue<span class="token punctuation">\</span>Day-04<span class="token punctuation">\</span>webpack模块化支持<span class="token operator">></span>webpack ./main.js ./bundle.js
...
<h3 id="vue-cli3脚手架的使用" tabindex="-1"><a class="header-anchor" href="#vue-cli3脚手架的使用" aria-hidden="true">#</a> vue-cli3脚手架的使用</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="拉取-2-x-模板-旧版本" tabindex="-1"><a class="header-anchor" href="#拉取-2-x-模板-旧版本" aria-hidden="true">#</a> 拉取 2.x 模板 (旧版本)</h3>
<blockquote>
<p>Vue CLI &gt;= 3 和旧版使用了相同的 vue 命令，所以 Vue CLI 2 (vue-cli) 被覆盖了。如果你仍然需要使用旧版本的 vue init 功能，你可以全局安装一个桥接工具：</p>
</blockquote>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> @vue/cli-init
<span class="token comment"># `vue init` 的运行效果将会跟 `vue-cli@2.x` 相同</span>
vue init webpack my-project
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="使用vue-cli-2-x-创建项目" tabindex="-1"><a class="header-anchor" href="#使用vue-cli-2-x-创建项目" aria-hidden="true">#</a> 使用vue-cli 2.x 创建项目</h3>
<h4 id="使用webpack-simple创建项目" tabindex="-1"><a class="header-anchor" href="#使用webpack-simple创建项目" aria-hidden="true">#</a> 使用webpack-simple创建项目</h4>
<ol>
...
<h4 id="使用webpack创建项目" tabindex="-1"><a class="header-anchor" href="#使用webpack创建项目" aria-hidden="true">#</a> 使用webpack创建项目</h4>
<ol>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> vue-router <span class="token parameter variable">-S</span>  // 局部安装vue-router
// 安装报错的话指定版本安装
...
<h4 id="_1-entry" tabindex="-1"><a class="header-anchor" href="#_1-entry" aria-hidden="true">#</a> 1. entry</h4>
<blockquote>
<p>项目的入口文件, (main.js或者index.js)</p>
</blockquote>
<h4 id="_2-output" tabindex="-1"><a class="header-anchor" href="#_2-output" aria-hidden="true">#</a> 2. output</h4>
<blockquote>
<p>输出出口</p>
</blockquote>
<h4 id="_3-loading" tabindex="-1"><a class="header-anchor" href="#_3-loading" aria-hidden="true">#</a> 3. loading</h4>
<blockquote>
