...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="vue的全家桶-vue-vue-router-vuex" tabindex="-1"><a class="header-anchor" href="#vue的全家桶-vue-vue-router-vuex" aria-hidden="true">#</a> Vue的全家桶（Vue+Vue-router+Vuex）</h3><h4 id="spa-single-page-application" tabindex="-1"><a class="header-anchor" href="#spa-single-page-application" aria-hidden="true">#</a> SPA（Single Page Application）</h4><h3 id="vue-router" tabindex="-1"><a class="header-anchor" href="#vue-router" aria-hidden="true">#</a> Vue-router</h3><p>安装：</p><ol><li>CDN引入： <ol><li>vue-2.0： <a href="https://unpkg.com/vue-router@2.0.0/dist/vue-router.js" target="_blank" rel="noopener noreferrer">https://unpkg.com/vue-router@2.0.0/dist/vue-router.js`);
  _push(ssrRenderComponent(_component_ExternalLinkIcon, null, null, _parent));
  _push(`</a></li><li>vue-3.0： <a href="https://unpkg.com/vue-router@4.0.15/dist/vue-router.global.js%E3%80%82" target="_blank" rel="noopener noreferrer">https://unpkg.com/vue-router@4.0.15/dist/vue-router.global.js。`);
  _push(ssrRenderComponent(_component_ExternalLinkIcon, null, null, _parent));
  _push(`</a></li></ol></li><li>文件引入</li></ol><blockquote><p>VUe的核心插件<br> 文档参考：<a href="https://router.vuejs.org/zh/" target="_blank" rel="noopener noreferrer">https://router.vuejs.org/zh/`);
  _push(ssrRenderComponent(_component_ExternalLinkIcon, null, null, _parent));
  _push(`</a></p></blockquote><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code> Vue Router 是 Vue.js 的官方路由。它与 Vue.js 核心深度集成，让用 Vue.js 构建单页应用变得轻而易举。功能包括：  
● 嵌套路由映射
● 动态路由选择
● 模块化、基于组件的路由配置
● 路由参数、查询、通配符
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><table username:="" tom,="" post_id:="" 123=""><thead><tr><th>模式</th><th>匹配路径</th><th>$route.params</th></tr></thead><tbody><tr username:="" tom=""><td>/user/:username</td><td>/user/tom</td><td></td></tr><tr><td>/user/:username/post/:post_id</td><td>/user/tom/post/123</td><td></td></tr></tbody></table><ol start="2"><li>响应路由参数的变化</li></ol><blockquote><p>当使用路由参数时，<code>符合相同路由规则的导航</code>，例如从 /user/foo 导航到 /user/bar，<strong>原来的组件实例会被复用</strong>。因为两个路由都渲染同个组件，比起销毁再创建，复用则显得更加高效。<strong>不过，这也意味着组件的生命周期钩子不会再被调用</strong>。</p></blockquote><p>使用watch属性，监测路由的变化</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 动态路由试例</span>
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../pages/posts/Vue/Vue基础.html.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Vue___html = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__file", "Vue基础.html.vue"]]);
export {
