import { g as getDefaultExportFromCjs, c as commonjsGlobal } from "./commonjsHelpers-7a77ea84.js";
import { c as commonjsRequire } from "./commonjs-dynamic-modules-58f2b0ec.js";
...
(function(module, exports) {
  !function(t, e, r, a, o) {
    var n = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : "undefined" != typeof window ? window : "undefined" != typeof commonjsGlobal ? commonjsGlobal : {}, i = "function" == typeof n[a] && n[a], s = i.cache || {}, l = "function" == typeof commonjsRequire && commonjsRequire.bind(module);
    function c(e2, r2) {
      if (!s[e2]) {
        if (!t[e2]) {
    ...
    class X extends c.default {
      constructor(t2, e2) {
        ...
        if (r2.container = t2.container, this.option = (0, s.default)(r2, d.default), this.isLock = false, this.isReady = false, this.isFocus = false, this.isInput = false, this.isRotate = false, this.isDestroy = false, this.template = new g.default(this), this.events = new M.default(this), this.storage = new W.default(this), this.icons = new _.default(this), this.i18n = new y.default(this), this.notice = new z.default(this), this.player = new x.default(this), this.layers = new B.default(this), this.controls = new j.default(this), this.contextmenu = new $.default(this), this.subtitle = new E.default(this), this.info = new I.default(this), this.loading = new A.default(this), this.hotkey = new F.default(this), this.mask = new P.default(this), this.setting = new q.default(this), this.plugins = new Y.default(this), "function" == typeof e2 && this.on("ready", () => e2.call(this, this)), X.DEBUG) {
      ...
      loadImg(t2) {
        return new Promise((e2, r2) => {
          ...
          if (t2 instanceof HTMLImageElement)
            ...
            if ("string" != typeof t2)
              return r2(new o.ArtPlayerError("Unable to get Image"));
            a2 = new Image(), a2.src = t2;
          }
          if (a2.complete)
            return e2(a2);
          this.proxy(a2, "load", () => e2(a2)), this.proxy(a2, "error", () => r2(new o.ArtPlayerError(`Failed to load Image: ${a2.src}`)));
        });
      }
      remove(t2) {
...
})(artplayer$2, artplayer$2.exports);
var artplayerExports = artplayer$2.exports;
const artplayer = /* @__PURE__ */ getDefaultExportFromCjs(artplayerExports);
const artplayer$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: artplayer
}, [artplayerExports]);
export {
