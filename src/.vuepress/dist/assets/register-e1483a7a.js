...
class AudioProviderLoader {
  ...
  async load() {
    return new (await __vitePreload(() => import("./provider-a920a529.js"), true ? ["assets/provider-a920a529.js","assets/provider-34650b59.js","assets/app-c2e03701.js"] : void 0)).AudioProvider(this.kh);
  }
  render($store) {
    return (() => {
...
class VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-7a0b5c83.js"), true ? ["assets/provider-7a0b5c83.js","assets/provider-34650b59.js","assets/app-c2e03701.js"] : void 0)).VideoProvider(this.aa, context);
  }
  render($store) {
...
const _HLSProviderLoader = class extends VideoProviderLoader {
  ...
  async load(context) {
    return new (await __vitePreload(() => import("./provider-32c7caeb.js"), true ? ["assets/provider-32c7caeb.js","assets/provider-7a0b5c83.js","assets/provider-34650b59.js","assets/app-c2e03701.js"] : void 0)).HLSProvider(this.aa, context);
  }
};
...
class TextTrack extends EventsTarget {
  constructor(init) {
    ...
    if (!this.type)
      this.type = "vtt";
    if (init.content) {
      __vitePreload(() => import("./prod-86db5b8c.js"), true ? ["assets/prod-86db5b8c.js","assets/app-c2e03701.js"] : void 0).then(({ parseText: parseText2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 }) => {
        if (init.type === "json") {
  ...
  async Na() {
    ...
    try {
      const { parseResponse: parseResponse2, VTTCue: VTTCue2, VTTRegion: VTTRegion2 } = await __vitePreload(() => import("./prod-86db5b8c.js"), true ? ["assets/prod-86db5b8c.js","assets/app-c2e03701.js"] : void 0), crossorigin = (_a3 = this[TEXT_TRACK_CROSSORIGIN]) == null ? void 0 : _a3.call(this);
...
class ThumbnailsLoader extends ComponentController {
  ...
  Uf() {
    ...
    if (!src)
      return;
    __vitePreload(() => import("./prod-86db5b8c.js"), true ? ["assets/prod-86db5b8c.js","assets/app-c2e03701.js"] : void 0).then(({ parseResponse: parseResponse2 }) => {
      parseResponse2(
        fetch(src, {
...
async function parseTextStream(stream, options) {
  ...
  if (typeof type === "string") {
    switch (type) {
      case "srt":
        factory = (await __vitePreload(() => import("./srt-parser-c8a37559.js"), true ? ["assets/srt-parser-c8a37559.js","assets/app-c2e03701.js"] : void 0)).default;
        break;
      case "ssa":
      case "ass":
        factory = (await __vitePreload(() => import("./ssa-parser-ab0cd0cd.js"), true ? ["assets/ssa-parser-ab0cd0cd.js","assets/app-c2e03701.js"] : void 0)).default;
        break;
      default:
...
class VTTParser {
  ...
  async init(init) {
    ...
    if (init.strict)
      this.c = 1;
    if (init.errors)
      this.d = (await __vitePreload(() => import("./errors-1808ba97.js"), true ? ["assets/errors-1808ba97.js","assets/app-c2e03701.js"] : void 0)).ParseErrorBuilder;
  }
